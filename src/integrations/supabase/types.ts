...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      billing: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "billing_cv_id_fkey"
            columns: ["cv_id"]
            isOneToOne: false
      ...
      cv_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "cv_assignments_cv_id_fkey"
            columns: ["cv_id"]
            isOneToOne: false
            referencedRelation: "cv_uploads"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "cv_assignments_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      recruiter_actions: {
        ...
        Relationships: [
          {
            foreignKeyName: "recruiter_actions_cv_id_fkey"
            columns: ["cv_id"]
            isOneToOne: false
            referencedRelation: "cv_uploads"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "recruiter_actions_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Functions: {
      candidate_assigned_to_user_org: {
